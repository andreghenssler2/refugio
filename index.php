...
<body>
    ...
    <?php
    include("mod/components/menu_index.php");
    ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6" data-aos="fade-left" >
                    ...
                    <img src="<?php echo UPLOADS_IMG_URL; ?>1779749327_6.jpg" class="img-fluid rounded img_hover">
            ...
            <div class="row">
                ...
                <div class="col-md-4" data-aos="zoom-in">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/locais/index.php?id=cabana&local=Cabana" class="btn btn-success">
                                Ver disponibilidade
                            </a>
                ...
                <div class="col-md-4" data-aos="zoom-in">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/locais/index.php?id=chale&local=Chalé" class="btn btn-success">
                                Ver disponibilidade
                            </a>
                ...
                <div class="col-md-4" data-aos="zoom-in">
                    ...
                    <div class="card shadow position-relative overflow-hidden">
                        ...
                        <!-- FAIXA EM BREVE -->
                        <div class="position-absolute top-0 start-0 w-100 text-center py-2 divulgacao-embreve"
                            style="">
                        ...
                        <img src="<?php echo UPLOADS_IMG_URL; ?>1783551041_0.jpeg" class="card-img-top"
            ...
            <div class="row gallery">
                ...
                <?php foreach ($imgs as $img): ?>
                    ...
                    <div class="col-md-4 mb-4" data-aos="fade-up">
                        <img src="<?php echo UPLOADS_IMG_URL . $img['arquivo']; ?>" alt="Imagem da galeria"
    ...
    <?php
    include("mod/components/footer.php");
    ?>
